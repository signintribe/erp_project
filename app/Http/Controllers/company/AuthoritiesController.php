...
class AuthoritiesController extends Controller
{
    ...
    public function store(Request $request)
    {
        if($request->id){
            ...
            $address = $request->except('id','company_id','company_name','address_id','contact_id','social_id','authority_name','phone_number','mobile_number','fax_number','whatsapp','email','website','twitter','instagram','facebook','linkedin','pinterest','youtube','created_at','updated_at');
            ...
            $social = $request->except('id','company_id','company_name','address_id','contact_id','social_id','authority_name','address_line_1','address_line_2','address_line_3','street','sector','city','state','country','postal_code','zip_code','phone_number','mobile_number','fax_number','whatsapp','email','created_at','updated_at');
            ...
            $authoritydetail = $request->except('address_line_1','address_line_2','address_line_3','street','sector','city','state','country','postal_code','zip_code','phone_number','mobile_number','fax_number','whatsapp','email','website','twitter','instagram','facebook','linkedin','pinterest','youtube');
