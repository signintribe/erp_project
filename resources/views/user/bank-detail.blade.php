            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="bank_name" class="form-control" ng-model="company.bank_name" placeholder="Enter Your Bank Name.."/>
                        <i class="text-danger" ng-show="!company.bank_name && showError"><small>Please Type bank Name</small></i>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3">
                    <div class="form-group">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr ng-repeat="company in contacts">
                        ...
                        <td>
                            <button class="btn btn-info btn-xs" ng-click="editComBankDetail(company.id)">Edit</button>
                            <button class="btn btn-danger btn-xs" ng-click="deleteComBankDetail(company.id)">Delete</button>
                        </td>
                    </tr>
                </tbody>
            </table>
...
<script>
    ...
    BankDetail.controller('BankDetailController', function ($scope, $http) {
        ...
        $scope.deleteComBankDetail = function (id) {
            swal({
                title: "Are you sure?",
        ...
        $scope.editComBankDetail = function (id) {
            $http.get('maintain-company-bankdetail/' + id + '/edit').then(function (response) {
                if (response.data[0]) {
        ...
        $scope.save_comBankDetail = function () {
