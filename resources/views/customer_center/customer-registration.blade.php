        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3">
                    ...
                    <select class="form-control" id="customer_name" ng-options="customer.id as customer.customer_name for customer in customerinformations" ng-model="registration.actor_id">
                        <option value="">Select Customer Name</option>
                    </select>
                    <i class="text-danger" ng-show="!registration.actor_id && showError"><small>Please Select Customer</small></i>
                </div>
...
@endsection
@section('internaljs')
<script src="{{asset('ng_controllers/sales/customer-registration.js')}}"></script>
@endsection