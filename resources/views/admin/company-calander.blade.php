        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3">
                    ...
                    <input type="text" ng-model="calander.hoursin_day" id="working_hours" class="form-control" placeholder="Working Hours in a day">
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3">
                    ...
                    <input type="text" ng-model="calander.hoursin_month" id="working_hours_months" class="form-control" placeholder="Working Hours in a month">
                </div>
            </div><br>
            <div class="row">
                <div class="col">
