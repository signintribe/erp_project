...
@section('title', 'Company Departments')
@section('pagetitle', 'Company Departments')
@section('breadcrumb', 'Company Departments')
@section('content')
<div ng-controller="DepartmentsController" ng-cloak>
    <div class="card">
...
@endsection
@section('internaljs')
<script src="{{asset('ng_controllers/creation_company/departments.js')}}"></script>
@endsection