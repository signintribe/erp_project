...
<div ng-app="QueryApp" ng-controller="QueryController" ng-cloak>
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col">
                    <select class="form-control form-control-lg" ng-model="search.status">
                ...
                <div class="col">
                    <input type="text" class="form-control" datepicker placeholder="To Date" ng-model="search.todate"/>
                </div>
                <div class="col">
                    <input type="text" class="form-control" datepicker placeholder="From Date" ng-model="search.fromdate"/>
                </div>
                <div class="col">
                    <button class="btn btn-md btn-success" ng-click="search_query()">Search</button>
                </div>
            </div><br/>
...
//                            scope[attrs.ngModel] = dateObj.getFullYear() + '-' + (dateObj.getMonth() + 1) + '-' + dateObj.getDate();
    ...
    CompanyQueries.controller('QueryController', function ($scope, $http) {
        $scope.all_queries = function () {
            ...
            $http.get('all-queries-report').then(function (response) {
        ...
        $scope.search_query = function () {
            ...
            $http.post('search-queries', Data, {transformRequest: angular.identity, headers: {'Content-Type': undefined}}).then(function (res) {
