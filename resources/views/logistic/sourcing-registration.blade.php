        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3" ng-init="getLogisticInfo();">
                    ...
                    <select class="form-control" id="select_employee" ng-options="user.id as user.organization_name for user in Users" ng-model="registration.actor_id">
                        <option value="">Select Organization</option>
                    </select>
                    <i class="text-danger" ng-show="!registration.actor_id && showError"><small>Please Select Organization</small></i>
                </div>
            ...
            <table class="table table-sm table-bordered">
                ...
                <tbody>
                    <tr ng-repeat="r in allregistration">
                        ...
                        <td ng-bind="r.organization_name"></td>
                        <td>
                            <div class="btn-group">
...
<script>
    ...
    Company.controller('RegistrationController', function ($scope, $http) {
        ...
        $("#sourcing-registration").addClass('active');
        ...
        $scope.allcompany_registrations = function () {
            $scope.allregistration = {};
            $http.get($scope.appurl + 'manage-registration/sourcing-'+$("#company_id").val()).then(function (response) {
                if (response.data.length > 0) {
        ...
        $scope.save_companyregistration = function () {
            ...
            $scope.registration.actor_name = 'sourcing';
