...
@section('title', 'Add Carriage Company')
@section('content')
<div  ng-app="CarriageCompanyApp" ng-controller="CarriageCompanyController" ng-cloak>
    <div class="card">
        <div class="card-body">
            <h3 class="card-title">Carriage Company Information</h3>
            <div class="row">
...
<script>
    var CarriageCompany = angular.module('CarriageCompanyApp', []);
    CarriageCompany.controller('CarriageCompanyController', function ($scope, $http) {
