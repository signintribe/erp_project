...
<style>
    ...
    .catstyle div.catstyletwo
    {
        border-left: dotted 1px #1dc9a6;
    }
    .catstyle .second-cat .catstyletwo .second-cat .catstyletwo
    {
        border-left: dotted 1px red;
    }
    .catstyle .second-cat .checkbox label::before
    {
        width: 12px;
        height: 12px;
        margin-top: 0px;
    ...
    .catstyle .second-cat .checkbox label::after
    {
        padding-top: 0px;
    }
    .catstyle .second-cat .catstyletwo .second-cat .checkbox span
    {
        margin-right: 9px;
        margin-top: 0px;
    }
