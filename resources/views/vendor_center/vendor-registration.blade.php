        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3" ng-init="getVendors()">
                    ...
                    <select class="form-control"  ng-options="vendor.id as vendor.organization_name for vendor in vendorinformations" ng-model="registration.actor_id">
                        <option value="">Select Organization Name</option>
                    </select>
                    <i class="text-danger" ng-show="!registration.actor_id && showError"><small>Please Enter Organization</small></i>
                </div>
...
<script>
    ...
    Company.controller('RegistrationController', function ($scope, $http) {
        ...
        $("#vendor-registration").addClass('active');
        ...
        $scope.allcompany_registrations = function () {
            $scope.allregistration = {};
            $http.get($scope.appurl + 'manage-registration/vendor-'+$("#company_id").val()).then(function (response) {
                if (response.data.length > 0) {
        ...
        $scope.save_companyregistration = function () {
            ...
            $scope.registration.actor_name = 'vendor';
